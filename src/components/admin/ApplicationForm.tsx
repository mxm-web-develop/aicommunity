...
import { Upload, X, File, Image, Video, Search, UserPlus } from 'lucide-react';
    ...
    const handleFileUpload = async (files: File[] | FileList) => {
        ...
        const uploadPromises = fileArray.map(async (file) => {
            ...
            if (file.size > MAX_FILE_SIZE) {
                toast.error(`文件大小超过限制: ${file.name}`);
                return null;
            }
                                        ...
                                        <div className="space-y-1 text-center">
                                            ...
                                            {(imagePreview || formData.banner.coverImg) ? (
                                                <div className="relative group">
                                                    <img
                                                        src={imagePreview || formData.banner.coverImg}
                                                        alt="Banner preview"
